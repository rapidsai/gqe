...
// CUPTI headers
//
// GQE note: The relevant macro `CUPTI_API_CALL` from `helper_cupti.h` is
// redefined in `src/utility/cupti.cpp`.
//
...
public:
  ...
  std::vector<ProfilerRange>& GetProfilerRange() {
...
)
{
    ...
    // Get Num of Passes
    {
        ...
        numOfPasses = getNumOfPassesParam.numOfPasses;
    }
