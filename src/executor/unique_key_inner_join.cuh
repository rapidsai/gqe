...
struct always_not_equal {
  __device__ constexpr bool operator()(
    cuco::pair<cudf::hash_value_type, cudf::detail::row::rhs_index_type> const&,
    cuco::pair<cudf::hash_value_type, cudf::detail::row::rhs_index_type> const&) const noexcept
  {
...
class unique_key_join {
 ...
 private:
  ...
  using hash_table_type =
    cuco::static_set<cuco::pair<cudf::hash_value_type, cudf::detail::row::rhs_index_type>,
                     cuco::extent<std::size_t>,  // size_t avoids overflow issues with large tables
                     cuda::thread_scope_device,
                     always_not_equal,
                     probing_scheme_type,
                     rmm::mr::polymorphic_allocator<
                       cuco::pair<cudf::hash_value_type, cudf::detail::row::rhs_index_type>>,
                     cuco_storage_type>;
