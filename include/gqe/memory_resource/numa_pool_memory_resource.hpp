 ...
 */
class numa_pool_memory_resource {
 public:
  /**
   ...
   */
  friend void get_property(numa_pool_memory_resource const&, cuda::mr::device_accessible) noexcept
  {
  }

  [[nodiscard]] bool operator==(numa_pool_memory_resource const& other) const noexcept
  {
    return this == &other;
  }
  [[nodiscard]] bool operator!=(numa_pool_memory_resource const& other) const noexcept
