...
TEST_F(HandCodedValuesAggregationTest, Reduction)
{
  std::vector<std::pair<cudf::aggregation::Kind, std::unique_ptr<gqe::expression>>> values;
  values.push_back(
    std::make_pair(cudf::aggregation::SUM, std::make_unique<gqe::column_reference_expression>(1)));
  values.push_back(
    std::make_pair(cudf::aggregation::SUM, std::make_unique<gqe::column_reference_expression>(2)));
  values.push_back(
    std::make_pair(cudf::aggregation::MAX, std::make_unique<gqe::column_reference_expression>(2)));
