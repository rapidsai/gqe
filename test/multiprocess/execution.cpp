...
class MultiProcessExecutionTest : public ::testing::Test {
 protected:
  MultiProcessExecutionTest()
    : task_manager_ctx{},
  ...
  gqe::multi_process_task_manager_context task_manager_ctx;
  gqe::query_context query_ctx;
  gqe::context_reference ctx_ref;
};

TEST_F(MultiProcessExecutionTest, SingleGPUExecution)
{
  ASSERT_EQ(task_manager_ctx.get_mpi_rank(), 0);
  ASSERT_EQ(task_manager_ctx.get_mpi_size(), 1);
  ...
  // TODO: replace with multi-process executor once implemented
