 ...
 *   https://docs.nvidia.com/cuda/archive/12.9.0/cuda-runtime-api/group__CUDART__MEMORY__POOLS.html
 */
class shared_numa_pool_resource {
 public:
  ...
  ~shared_numa_pool_resource() noexcept = default;
   ...
   */
  friend void get_property(shared_numa_pool_resource const&, cuda::mr::device_accessible) noexcept
  {
  }

  [[nodiscard]] bool operator==(shared_numa_pool_resource const& other) const noexcept
  {
    return this == &other;
  }
  [[nodiscard]] bool operator!=(shared_numa_pool_resource const& other) const noexcept
