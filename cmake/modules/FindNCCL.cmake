...
#
# The following variables are optionally searched for defaults NCCL_ROOT: Base
# directory where all NCCL components are found NCCL_INCLUDE_DIR: Directory
...
# Compatible layer for CMake <3.12. NCCL_ROOT will be accounted in for searching
# paths and libraries for CMake >=3.12.
...
if(USE_STATIC_NCCL)
  ...
  if(NCCL_VERSION) # Prefer the versioned library if a specific NCCL version is
                   # specified
